...
class AuthService {
  ...
  Future signInWitEmailAndPassword(String email, String password) async {
    try {
      AuthResult authResult = await _auth.signInWithEmailAndPassword(
          email: email, password: password); //get response from the function
      FirebaseUser user =
          authResult.user; //store the result in firebase user object
  ...
  Future registerWitEmailAndPassword(
