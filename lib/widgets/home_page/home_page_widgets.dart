...
final AuthNotifier _authNotifier = new AuthNotifier();
...
//   final currentUserUID = _authNotifier.user.uid;
...
class ProjectsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //Stream<List<Project>> projects = Provider.of<Stream<List<Project>>>(context);
    //print(projects.first.toString());
